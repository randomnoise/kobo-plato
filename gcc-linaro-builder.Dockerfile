...
# checksum is the same with Kobo Reader's toolchain Git LFS file:
...
RUN tar -xJvf gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf.tar.xz \
 && mv -v /gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/ /gcc-linaro/ \
 && rm -fv /gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf.tar.xz
